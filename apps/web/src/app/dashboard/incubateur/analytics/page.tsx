  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-linear-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-white">
          <BarChart3 size={18} />
        </div>
        <div>
          ...
          {ANALYTICS_CHARTS.evolution.map((d, i) => (
            <div key={d.year} className="flex-1 flex flex-col items-center gap-1">
              ...
              <motion.div
                ...
                className="w-full rounded-t-md bg-linear-to-t from-pink-500 to-fuchsia-500"
                style={{ minHeight: 4 }}
              />
            ...
            {ANALYTICS_CHARTS.funding.map((d, i) => (
              <div key={d.year} className="flex-1 flex flex-col items-center gap-1">
                ...
                <motion.div
                  ...
                  className="w-full rounded-t-md bg-linear-to-t from-emerald-500 to-teal-500"
                  style={{ minHeight: 4 }}
                />
            ...
            <div key={b.country} className="flex items-center gap-3">
              ...
              <div className="flex-1 h-3 bg-gray-100 dark:bg-white/8 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className={`h-full rounded-full ${i === 0 ? 'bg-linear-to-r from-pink-500 to-fuchsia-500' : 'bg-gray-300 dark:bg-gray-600'}`}
                />
              </div>
              <span
